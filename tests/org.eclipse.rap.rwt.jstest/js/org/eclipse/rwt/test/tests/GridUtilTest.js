...
//    },
    ...
    testVerticalGridLayoutOnSplitTree : function() {
      ...
      tree.setLinesVisible( true );
      TestUtil.flush();
      var cont1 = tree.getRowContainer().getSubContainer( 0 ).getElement();
      var cont2 = tree.getRowContainer().getSubContainer( 1 ).getElement();
      assertEquals( 3, cont1.childNodes.length );
      assertEquals( 4, cont2.childNodes.length ); // column count is 5
    ...
    testVerticalGridLayoutOnChangeFixedColumns : function() {
      ...
      assertEquals( 6, cont2.childNodes.length ); // column count is 5
      tree.destroy();
    },
